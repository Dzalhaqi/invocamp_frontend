    ...
    <section className="bg-white dark:bg-gray-900 ">
      <div className="container flex items-center justify-center min-h-screen px-6 py-12 mx-auto">
        <div className="w-full ">
          ...
          <div className="grid w-full max-w-6xl grid-cols-1 gap-8 mx-auto mt-8 md:grid-cols-2">
            <div className="p-6 rounded-lg bg-blue-50 dark:bg-gray-800">
              ...
              <p className="mt-2 text-gray-500 dark:text-gray-400 ">
                Dive in to learn all about our services.
              </p>
            ...
            <div className="p-6 rounded-lg bg-blue-50 dark:bg-gray-800">
              ...
              <p className="mt-2 text-gray-500 dark:text-gray-400 ">
                Get the latest posts of your deream vacancy.
              </p>

              <Link
                href="/vacancies"
                className="inline-flex items-center mt-4 text-sm text-blue-500 gap-x-2 dark:text-blue-400 hover:underline">
                <span>View lastest vacancies</span>
