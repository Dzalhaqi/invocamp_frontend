    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg md:rounded-2xl border border-gray-200 dark:border-gray-700">
      ...
      <form className="p-5 w-full">
        <div className="">
          <a
            href="#"
            className="flex items-center justify-center px-6 py-3 text-gray-600 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 bg-gray-50 dark:bg-gray-700">
