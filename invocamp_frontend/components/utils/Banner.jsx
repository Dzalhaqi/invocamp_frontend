...
const Banner = () => {
  return (
    <div
      id="sticky-banner"
      tabIndex="-1"
      className="left-0 z-50 flex justify-between w-full p-4 border-b border-gray-200 bg-white/80 dark:bg-gray-700 dark:border-gray-600">
      <div className="flex items-center mx-auto">
        <p className="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
          ...
          <span>
            InvoCamp website is being constructed. if there is any questions
            feel fee to contact us at {` `}
            <a
